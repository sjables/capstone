...
#-------------- back-end (END)--------------------------#
    ...
    lang1 = r'"s3://saracapstone/tessdata/ara"'
    lang2 = r'"s3://saracapstone/tessdata/ara"+"s3://saracapstone/tessdata/ckbLayer"+"s3://saracapstone/tessdata/sarchia"'
    lang3 = r'"s3://saracapstone/tessdata/ara"+"s3://saracapstone/tessdata/ckbLayer"'
